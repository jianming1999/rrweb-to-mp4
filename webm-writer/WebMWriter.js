...
(function() {
    ...
    function decodeBase64WebPDataURL(url) {
        ...
        // return new Buffer(url.substring("data:image\/webp;base64,".length) , 'base64').toString();
        return Buffer.from(url.substring("data:image\/webp;base64,".length) , 'base64').toString();
    }
